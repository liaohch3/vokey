...
pub struct SiliconFlowWhisperProvider {
    client: Client,
    api_key: String,
    model: String,
...
impl SiliconFlowWhisperProvider {
...
impl SttProvider for SiliconFlowWhisperProvider {
    fn transcribe(&self, wav_data: &[u8]) -> Result<String, SttError> {
        ...
        let parsed: SiliconFlowTranscriptionResponse =
